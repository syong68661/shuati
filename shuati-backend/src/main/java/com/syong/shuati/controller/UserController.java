...
import com.syong.shuati.config.WxOpenConfig;
...
import com.syong.shuati.model.dto.user.*;
...
import com.syong.shuati.service.impl.UserServiceImpl;
...
//        String tokenValue= request.getHeader(StpUtil.getTokenValue());
...
//        log.info("token = {}", tokenName);
    ...
    public BaseResponse<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        String encryptPassword = UserServiceImpl.encodePassword(defaultPassword);
