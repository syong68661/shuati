...
@Slf4j
@Component
@ConditionalOnProperty(prefix = "app.nacos-listener", name = "enabled", havingValue = "true", matchIfMissing = true)
public class NacosListener implements InitializingBean, DisposableBean {
    ...
    @Value("${nacos.config.data-id:shuati}")
