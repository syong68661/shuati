...
import com.syong.shuati.mapper.QuestionMapper;
...
//import com.syong.shuati.model.entity.QuestionFavour;
//import com.syong.shuati.model.entity.QuestionThumb;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public Page<Question> searchFromEs(QuestionQueryRequest questionQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            ...
            boolQueryBuilder.should(QueryBuilders.matchQuery("tags", searchText)); // ✅ 加上这个
    ...
    @Override
    public List<String> listQuestionTagList(String searchText) {
        QueryWrapper<Question> queryWrapper = new QueryWrapper<>();
        ...
        return questionList.stream()
            ...
            .map(String::valueOf)
            .filter(StringUtils::isNotBlank)
            .filter(tag -> StringUtils.isBlank(searchText) || StringUtils.containsIgnoreCase(tag, searchText))
            .distinct()
            .sorted()
            .limit(50)
            .collect(Collectors.toList());
